...
const firebaseConfig = {
    apiKey: "AIzaSyDMHX0U8EmMpypv8hpCig6blzQ47uS5oAg",
    authDomain: "e-commerce110302.firebaseapp.com",
    projectId: "e-commerce110302",
    storageBucket: "e-commerce110302.appspot.com",
    messagingSenderId: "763561852075",
    appId: "1:763561852075:web:5e3513ead6f4b91da84bee",
    measurementId: "G-V2F370MD22",
    databaseUrl : 'https://console.firebase.google.com/u/0/project/e-commerce110302/database/e-commerce110302-default-rtdb/data/~2F'
  };
...
async function uploadProductData(productData) {
  try {
    ...
    const docRef = await addDoc(collection(db, "clothData"), productData);
  } catch (error) {
...
// Upload each product data to Firestore
products.forEach(uploadProductData);
export { app, db, collection, addDoc, deleteDoc, updateDoc, doc };